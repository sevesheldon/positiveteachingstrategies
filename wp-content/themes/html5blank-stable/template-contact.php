<?php /* Template Name: Contact Template */ get_header(); ?>
	...
	<main role="main">
		...
		<!-- section -->
		<section class="page-wrap" id="contact-page-wrap">

			<div class="contact-page-form-wrap">

				<h4>You can write me a message here:</h4>

				<?php echo do_shortcode( '[contact-form-7 id="1780" title="Contact Page Form"]' ); ?>
			...
			<?php if (have_posts()): while (have_posts()) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="page-content" id="contact-page-content">
						...
						<a class="button speaker-pop-up-button" id="contact-request">

							<li>Submit a Request for Proposal for Katrina to speak at your event</li>
